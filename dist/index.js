...
document.addEventListener("DOMContentLoaded", () => {
  ...
  var handleEnd = () => {
    ...
    if (!squig.socket.disconnected) squig.socket.emit("new-line", {
      id,
      line: squig.tempLine
    });
    squig.tempLine = {
      user: squig.socket.id,
